...
$lang = array (
  'faq_page_title' => 'Häufig gestellte Fragen - #SITE_TITLE#',
  'faq_menu_title' => 'FAQ',
  'faqpb_cats_number' => '7',
  'faqpb_c1_title' => 'Erste Schritte',
  'faqpb_c1_posts_number' => '3',
  'faqpb_c1_p1_title' => 'Was ist #SITE_TITLE# ?',
  'faqpb_c1_p1_text' => '#SITE_TITLE# ist ein Microblogging-Netzwerk. Microblogging ist eine beliebte Methode moderner Kommunikation über das Internet. Microblogs ermöglichen einen  Austausch von Kurznachrichten. Darüber hinaus kannst du auf #SITE_TITLE# deinen Nachrichten Daten, Links, Videos, und Bildern anhängen.',
  'faqpb_c1_p1_image' => 'frei',
  'faqpb_c1_p1_imgtxt' => 'frei',
  'faqpb_c1_p2_title' => 'Was sollte ich zuerst tun wenn ich mich angemeldet habe?',
  'faqpb_c1_p2_text' => 'Vielleicht solltest du zuerst dein Profil ausfüllen, damit deine Freunde dich hier auch finden um mit dir kommunizieren zukönnen.

[url=#SITE_URL#settings/profile]Trage hier deine Profil-Daten ein[/url]: Du kannst Name, Ort, Geburtdtsg, Geschlecht und Stichwörter angeben. [url=#SITE_URL#settings/avatar]Lade ein Profil-Bild hoch[/url] und [url=#SITE_URL#settings/contacts]trage deine Kontakt-Details ein[/url]. Du kannst auch andere Profile wie z.Bsp. die aus Facebook und Twitter verknüpfen.

Sobald dein Profil richtig ausgefüllt ist, kannst du mit anderen Mitgliedern im Netzerk kommunizieren. Du kannst Nachrichten schreiben, Gruppen beitreten, oder eigene Gruppen gründen.',
  'faqpb_c1_p2_image' => 'design/faq/profile.gif',
  'faqpb_c1_p2_imgtxt' => 'frei',
  'faqpb_c1_p3_title' => 'Wie kann ich Freunde finden und wie folge ich ihnen?',
